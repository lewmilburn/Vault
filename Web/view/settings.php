    ...
    <body>
        ...
        <main>
            ...
            <div class="grid">
                ...
                <input id="USERS_FILE" value="<?= USERS_FILE; ?>">

                <label for="SECURE_LOCATION">Secure Location</label>
                <input id="SECURE_LOCATION" value="<?= SECURE_LOCATION; ?>">

                <label for="FILE_SEPARATOR">File Separator</label>
                <input id="FILE_SEPARATOR" value="<?= FILE_SEPARATOR; ?>">

                <label for="DEFAULT_HASH">Default Hash</label>
                <input id="DEFAULT_HASH" value="<?= DEFAULT_HASH; ?>">

                <label for="USER_HASH">User Hash</label>
                <input id="USER_HASH" value="<?= USER_HASH; ?>">

                <label for="CHECKSUM_HASH">Checksum Hash</label>
                <input id="CHECKSUM_HASH" value="<?= CHECKSUM_HASH; ?>">
            </div>
            <div class="grid">
                <h2>Database Storage Settings</h2>
                <label for="DB_HOST">Database Host</label>
                <input id="DB_HOST" value="<?= DB_HOST; ?>">

                <label for="DB_NAME">Database Name</label>
                <input id="DB_NAME" value="<?= DB_NAME; ?>">

                <label for="DB_USER">Database User</label>
                <input id="DB_USER" value="<?= DB_USER; ?>">

                <label for="DB_PASS">Database Password</label>
                <input id="DB_PASS" value="<?= DB_PASS; ?>">

                <label for="DB_PORT">Database Port</label>
                <input id="DB_PORT" value="<?= DB_PORT; ?>">

                <label for="DB_SOCKET">Database Socket</label>
                <input id="DB_SOCKET" value="<?= DB_SOCKET; ?>">

                <label for="DB_PREFIX">Database Prefix</label>
                <input id="DB_PREFIX" value="<?= DB_PREFIX; ?>">
            </div>
        </main>
    </body>
</html>
